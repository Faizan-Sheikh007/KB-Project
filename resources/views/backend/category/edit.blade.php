...
<div class="main-panel">
  ...
  <div class="container">
            ...
            <div class="card-body">
              <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                   <form action="{{ route('category.update', $category->id) }}" method="POST" class="p-4 bg-white rounded-3 shadow-sm">
    @csrf
    @method('PUT')
    ...
    <div class="mb-3">
      ...
      <input type="text" name="subcategory" class="form-control" value="{{ $category->subcategory }}">
    </div>
