  ...
  <div class="container">
    <div class="page-inner">
      <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4 p-4">
        <div>
          <h3 class="fw-bold mb-3">Add productdetail</h3>
          ...
          <div class="card card-round">
            <div class="card-header">
              <div class="card-head-row card-tools-still-right">
                <div class="card-title">productdetails</div>
              </div>
            </div>
...
<form action="{{ route('productdetail.store') }}" method="POST" enctype="multipart/form-data" class="p-4 bg-white rounded-3 shadow-sm">
    @csrf
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6">
            ...
            <select class="form-control modern-input" id="product_id" name="product_id" required>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control modern-input" id="specifications" name="specifications" placeholder="Enter specifications" required>
        </div>

        <!-- Warranty -->
        <div class="col-md-6">
            <label for="warranty" class="form-label fw-semibold">Warranty</label>
            <input type="text" class="form-control modern-input" id="warranty" name="warranty" placeholder="Enter warranty" required>
        </div>

        <!-- Manufacturer -->
        <div class="col-md-12">
            <label for="manufacturer" class="form-label fw-semibold">Manufacturer</label>
            <textarea class="form-control modern-input" id="manufacturer" name="manufacturer" rows="4" placeholder="Enter manufacturer" required></textarea>
        </div>
