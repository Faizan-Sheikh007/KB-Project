  ...
  <div class="container">
    <div class="page-inner">
      <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4 p-4">
        <div>
          <h3 class="fw-bold mb-3">Add productdetails</h3>
          <h6 class="op-7 mb-2">Your Time Zone Admin Panel</h6>
        </div>
        <div class="ms-md-auto py-2 py-md-0">
          <a href="{{ route('productdetail.index') }}" class="btn btn-primary btn-round">See productdetails</a>
        </div>
      </div>
          ...
          <div class="card card-round">
            <div class="card-header">
              <div class="card-head-row card-tools-still-right">
                <div class="card-title">productdetail</div>
              </div>
            </div>
            ...
            <div class="card-body">
              <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                 <form action="{{ route('productdetail.update', $productdetail->id) }}" method="POST" enctype="multipart/form-data" class="p-4 bg-white rounded-3 shadow-sm">
                    @csrf
                    @method('PUT')
                    <div class="row g-4">
                      <div class="col-md-6">
                        <label for="heading" class="form-label fw-semibold">Heading</label>
                        <input type="text" class="form-control modern-input" id="heading" name="heading" placeholder="Enter heading" required value="{{ $productdetail->heading }}">
                      </div>

                      <div class="col-md-6">
                        <label for="buttonText" class="form-label fw-semibold">Price</label>
                        <input type="number" class="form-control modern-input" id="buttonText" name="price" placeholder="Enter button text" required value="{{ $productdetail->price }}">
                      </div>
   <div class="col-md-6">
                        <label for="buttonText" class="form-label fw-semibold">Quantity</label>
                        <input type="number" class="form-control modern-input" id="buttonText" name="quantity" placeholder="Enter button text" required value="{{ $productdetail->quantity }}">
                      </div>
                      <div class="col-md-12">
                        <label for="description" class="form-label fw-semibold">Description</label>
                        <textarea class="form-control modern-input" id="description" name="description" rows="4" placeholder="Enter productdetail description" required >{{ $productdetail->description }}</textarea>
                      </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="upload-box border rounded-3 bg-white p-4 text-center">
                          ...
                          <img src="{{ asset('storage/'. $productdetail->image) }}" style="width:100px;">
                        </div>
                      </div>
