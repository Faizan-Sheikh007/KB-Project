          ...
          <div class="page-inner">
            ...
            >
              ...
              <div class="ms-md-auto py-2 py-md-0">
                <a href="{{ route('product.create') }}" class="btn btn-primary btn-round">Add Product </a>
              </div>
            </div>
                      ...
                      <table class="table align-items-center mb-0">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th scope="col" class="text-start">Heading</th>
                            ...
                            <th scope="col" class="text-start">Subcateory</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-start">  {{ $product->heading }}</td>
                            <td class="text-start">{{ $product->description}}</td>


<td class="text-start">
    <img src="{{ asset('storage/'.$product->image) }}"
         alt="..." class="avatar-img rounded-circle" style="width: 50px">
</td>
    ...
    {{ $product->category->category ?? 'No Category' }}
                                  ...
                                  <td class="text-start">{{ $product->subcategory}}</td>
                                  <td class="text-end">

                              <a class="badge badge-success" href="{{ route('product.edit',$product->id) }}">Update</a>
