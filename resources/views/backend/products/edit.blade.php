            ...
            <div class="card-body">
              <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                 <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="p-4 bg-white rounded-3 shadow-sm">
                    @csrf
                    @method('PUT')
                    <div class="row g-4">
                      <div class="col-md-6">
                        <label for="heading" class="form-label fw-semibold">Heading</label>
                        <input type="text" class="form-control modern-input" id="heading" name="heading" placeholder="Enter heading" required value="{{ $product->heading }}">
                      </div>

                      <div class="col-md-6">
                        <label for="buttonText" class="form-label fw-semibold">Price</label>
                        <input type="number" class="form-control modern-input" id="buttonText" name="price" placeholder="Enter button text" required value="{{ $product->price }}">
                      </div> 
   <div class="col-md-6">
                        <label for="buttonText" class="form-label fw-semibold">Quantity</label>
                        <input type="number" class="form-control modern-input" id="buttonText" name="quantity" placeholder="Enter button text" required value="{{ $product->quantity }}">
                      </div> 
                      <div class="col-md-12">
                        <label for="description" class="form-label fw-semibold">Description</label>
                        <textarea class="form-control modern-input" id="description" name="description" rows="4" placeholder="Enter product description" required >{{ $product->description }}</textarea>
                      </div>
