                      ...
                      <table class="table align-items-center mb-0">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th scope="col" class="text-start">Text</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-start">  {{ $banner->heading }}</td>
...
@endif
                                  ...
                                  <td class="text-start">{{ $banner->button}}</td>
                                  <td class="text-end">
                               
                              <a class="badge badge-success" href="{{ route('banner.edit',$banner->id) }}">Update</a>
